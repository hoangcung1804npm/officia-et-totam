...
[![CI status](https://github.com/hoangcung1804npm/officia-et-totam/workflows/Node.js%20CI/badge.svg)](https://github.com/hoangcung1804npm/officia-et-totam/actions?query=workflow%3A%22Node.js+CI%22)
[![Coverage Status](https://coveralls.io/repos/github/hoangcung1804npm/officia-et-totam/badge.svg?branch=master)](https://coveralls.io/github/hoangcung1804npm/officia-et-totam?branch=master)
[![NPM version](https://img.shields.io/npm/v/@hoangcung1804npm/officia-et-totam.svg)](https://www.npmjs.com/package/@hoangcung1804npm/officia-et-totam)
![npm](https://img.shields.io/npm/dm/@hoangcung1804npm/officia-et-totam)
...
```bash
npm install @hoangcung1804npm/officia-et-totam
```
...
```javascript
// ESM
import { Validator } from "@hoangcung1804npm/officia-et-totam";
...
```javascript
// CommonJS
const { Validator } = await (import("@hoangcung1804npm/officia-et-totam"));
```
...
```bash
npm install @hoangcung1804npm/officia-et-totam -g
...
```bash
npx -p @hoangcung1804npm/officia-et-totam validate-api <filename>
```
...
```bash
npx -p @hoangcung1804npm/officia-et-totam bundle-api <spec files> 
```
